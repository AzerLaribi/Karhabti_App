...
class NoteTabsScreen extends StatefulWidget {
  static const routeName = '/note-tabs';
  @override
  State<NoteTabsScreen> createState() => _NoteTabsScreenState();
}

class _NoteTabsScreenState extends State<NoteTabsScreen> {
